...
describe('NFTDescriptor', () => {
  ...
  describe('#constructTokenURI', () => {
    ...
    it('snapshot matches', async () => {
      ...
      fee = FeeAmount.LOW
      quoteTokenAddress = '0x3c4e17b9056272ce1b49f6900d8cfd6171a1869d'
      baseTokenAddress = '0xa959726154953bae111746e265e6d754f48570e6'
      quoteTokenSymbol = 'AXS'
      baseTokenSymbol = 'WRON'
      expect(
        await nftDescriptor.constructTokenURI({
          tokenId,
          quoteTokenAddress,
  ...
  function constructTokenMetadata(
    ...
    return {
      name: `Katana - ${feeTier} - ${quoteTokenSymbol}/${baseTokenSymbol} - ${prices}`,
      description: `This NFT represents a liquidity position in a Katana V3 ${quoteTokenSymbol}-${baseTokenSymbol} pool. The owner of this NFT can modify or redeem the position.\n\
