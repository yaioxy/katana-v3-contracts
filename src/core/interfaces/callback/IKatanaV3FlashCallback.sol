...
/// @title Callback for IKatanaV3PoolActions#flash
/// @notice Any contract that calls IKatanaV3PoolActions#flash must implement this interface
interface IKatanaV3FlashCallback {
  /// @notice Called to `msg.sender` after transferring to the recipient from IKatanaV3Pool#flash.
