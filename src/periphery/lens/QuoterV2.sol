...
contract QuoterV2 is IQuoterV2, IKatanaV3SwapCallback, PeripheryImmutableState {
  ...
  function handleRevert(bytes memory reason, IKatanaV3Pool pool, uint256 gasEstimate)
    private
    view
