...
import "./PeripherialTestERC20.sol";
import "../interfaces/external/IERC20PermitAllowed.sol";

// has a fake permit that just uses the other signature type for type(uint256).max
contract TestERC20PermitAllowed is PeripherialTestERC20, IERC20PermitAllowed {
  constructor(uint256 amountToMint) PeripherialTestERC20(amountToMint) { }
