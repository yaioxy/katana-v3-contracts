...
contract MockObservations {
  ...
  function slot0() external view returns (uint160, int24, uint16, uint16, uint16, uint8, uint8, bool) {
    return (0, slot0Tick, slot0ObservationIndex, slot0ObservationCardinality, 0, 0, 0, false);
  }
